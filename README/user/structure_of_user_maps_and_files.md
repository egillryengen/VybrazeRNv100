...
•  Centralized manual mocks: We added module mocks under __mocks__ for userRepository and useDebouncedSave to avoid inline factory pitfalls and to make tests deterministic and reusable.
...
3.  Mocking and testability — standardize mocks for repository and autosave in test setup (module mocks under __mocks__).
